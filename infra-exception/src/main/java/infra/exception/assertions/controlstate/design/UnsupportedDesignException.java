...
public class UnsupportedDesignException extends IllegalControlStateException {
	...
	public UnsupportedDesignException() { super(); }
	public UnsupportedDesignException(String message) { super(message); }

	/** Raises exception if condition is false. */
	public static boolean apply(boolean condition) {
		if (!condition) throw new UnsupportedDesignException();
		return true;
	}

	public static void apply(boolean condition, String message) {
		if (! condition) throw new UnsupportedDesignException(message);
	}
}
