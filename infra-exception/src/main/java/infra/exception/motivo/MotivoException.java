...
public class MotivoException extends Exception {
	...
	public MotivoException(Motivo motivo, Object... args) {
		super(String.format(motivo.getMensagem(), args));
		this.motivo = motivo;
	}

	public MotivoException(Throwable causa, Motivo motivo, Object... args) {
	...
	public static String codigoMotivo(Motivo motivo) {
		String r = motivo.getClass().getSimpleName();
		if (motivo.getClass().isEnum()) {
			r+= ".";
			r+= ((Enum<?>)motivo).name();
		}
		return r;
